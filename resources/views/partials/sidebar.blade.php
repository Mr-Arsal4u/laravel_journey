        ...
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-item">
                ...
                <ul id="pages" class="sidebar-dropdown list-unstyled collapse " data-parent="#sidebar">
                    <li class="sidebar-item"><a class="sidebar-link" href="/profile">Profile</a></li>
                    <li class="sidebar-item"><a class="sidebar-link" href="/settings">Settings</a>
                    </li>
                    <li class="sidebar-item"><a class="sidebar-link" href="/clients">Clients</a></li>
                    <li class="sidebar-item">
            ...
            <li class="sidebar-item">
                ...
                <ul id="layouts" class="sidebar-dropdown list-unstyled collapse " data-parent="#sidebar">
                    <li class="sidebar-item"><a class="sidebar-link"
                            href="layouts-sidebar-sticky.html">Sticky Sidebar</a></li>
                    <li class="sidebar-item"><a class="sidebar-link"
                            href="layouts-sidebar-collapsed.html">Collapsed Sidebar</a></li>
                    <li class="sidebar-item"><a class="sidebar-link" href="layouts-boxed.html">Boxed
                            Layout</a></li>
                    <li class="sidebar-item"><a class="sidebar-link"
                            href="dashboard-analytics-1.html?theme=classic">Classic Theme</a></li>
                    <li class="sidebar-item"><a class="sidebar-link"
                            href="dashboard-analytics-2.html?theme=corporate">Corporate Theme <span
                                class="sidebar-badge badge badge-primary">New</span></a></li>
                    <li class="sidebar-item"><a class="sidebar-link"
            ...
            <li class="sidebar-item">
                ...
                <ul id="ui" class="sidebar-dropdown list-unstyled collapse " data-parent="#sidebar">
                    ...
                    <li class="sidebar-item"><a class="sidebar-link" href="ui-general.html">General <span
                                class="sidebar-badge badge badge-info">10+</span></a></li>
            ...
            <li class="sidebar-item">
                ...
                <ul id="charts" class="sidebar-dropdown list-unstyled collapse " data-parent="#sidebar">
                    ...
                    <li class="sidebar-item"><a class="sidebar-link" href="charts-apexcharts.html">ApexCharts
                            <span class="sidebar-badge badge badge-primary">New</span></a></li>
                </ul>
            </li>
            <li class="sidebar-item">
